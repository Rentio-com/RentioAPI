...
VALUES
    ('a1111111-1111-1111-1111-111111111111', 'c0000000-0000-0000-0000-000000000001', 'VW', 'Golf', 2022, 'KR 67890', 'WVW12345678901234', '2.0 TDI', 'DIESEL', 'MANUAL', 80, 42000, 'AVAILABLE', NOW(), NOW(), 'C', 'SEDAN'),
    ('a2222222-2222-2222-2222-222222222222', 'c0000000-0000-0000-0000-000000000001', 'Toyota', 'Corolla', 2023, 'KR 12345', 'JTD12345678901234', '1.8L Hybrid', 'HYBRID', 'AUTOMATIC', 100, 15000, 'READY_TO_RENT', NOW(), NOW(), 'B', 'COMPACT'),
    ('a3333333-3333-3333-3333-333333333333', 'c0000000-0000-0000-0000-000000000001', 'BMW', '3 Series', 2024, 'KR 33333', 'WBA12345678901234', '2.0 Diesel', 'DIESEL', 'AUTOMATIC', 60, 8000, 'RENTED', NOW(), NOW(), 'D', 'SEDAN');
...
INSERT INTO rentals (
    id, company_id, customer_id, vehicle_id, vehicle_type, vehicle_segment,
    scheduled_pickup, scheduled_return, actual_pickup, actual_return,
    daily_rate, estimated_total, final_total,
    pickup_address, pickup_city, pickup_lat, pickup_lng,
    return_address, return_city, return_lat, return_lng,
    rental_status,
    created_at, updated_at
)
VALUES
    ('d1111111-1111-1111-1111-111111111111', 'c0000000-0000-0000-0000-000000000001', 'b1111111-1111-1111-1111-111111111111', 'a3333333-3333-3333-3333-333333333333', 'SEDAN', 'D', '2026-04-10T10:00:00', '2026-04-17T10:00:00', '2026-04-10T10:15:00', NULL, 180.00, 1260.00, NULL, 'Balice Airport', 'Kraków', 50.0777, 19.7848, 'Balice Airport', 'Kraków', 50.0777, 19.7848, 'ACTIVE', NOW(), NOW()),

    ('d2222222-2222-2222-2222-222222222222', 'c0000000-0000-0000-0000-000000000001', 'b2222222-2222-2222-2222-222222222222', 'a1111111-1111-1111-1111-111111111111', 'HATCHBACK', 'C', '2026-04-20T09:00:00', '2026-04-25T09:00:00', NULL, NULL, 120.00, 600.00, NULL, 'Kraków Główny', 'Kraków', 50.0680, 19.9471, 'ul. Długa 15', 'Kraków', 50.0614, 19.9372, 'CONFIRMED', NOW(), NOW()),
...
INSERT INTO vehicle_insurances (
    id, company_id, vehicle_id, policy_type, insurer_name, policy_number,
    start_date, end_date, premium_amount, payment_frequency, active,
    created_at, updated_at, created_by
) VALUES
    ('aa111111-1111-1111-1111-111111111111', 'c0000000-0000-0000-0000-000000000001',
     'a1111111-1111-1111-1111-111111111111', 'OC', 'PZU', 'PZU/OC/2026/001',
     '2026-01-01', '2026-12-31', 1200.00, 'ANNUAL', true,
     NOW(), NOW(), gen_random_uuid()),

    ('aa222222-2222-2222-2222-222222222222', 'c0000000-0000-0000-0000-000000000001',
     'a1111111-1111-1111-1111-111111111111', 'AC', 'PZU', 'PZU/AC/2026/001',
     '2026-01-01', '2026-12-31', 2800.00, 'QUARTERLY', true,
     NOW(), NOW(), gen_random_uuid()),

    ('aa333333-3333-3333-3333-333333333333', 'c0000000-0000-0000-0000-000000000001',
     'a2222222-2222-2222-2222-222222222222', 'OC', 'Warta', 'WRT/OC/2026/045',
     '2026-03-01', '2027-02-28', 1400.00, 'ANNUAL', true,
     NOW(), NOW(), gen_random_uuid()),

    ('aa444444-4444-4444-4444-444444444444', 'c0000000-0000-0000-0000-000000000001',
     'a2222222-2222-2222-2222-222222222222', 'AC', 'Warta', 'WRT/AC/2026/045',
     '2026-03-01', '2027-02-28', 3200.00, 'QUARTERLY', true,
     NOW(), NOW(), gen_random_uuid()),

    ('aa555555-5555-5555-5555-555555555555', 'c0000000-0000-0000-0000-000000000001',
     'a3333333-3333-3333-3333-333333333333', 'OC', 'Allianz', 'ALZ/OC/2026/112',
     '2026-02-01', '2027-01-31', 1800.00, 'ANNUAL', true,
     NOW(), NOW(), gen_random_uuid()),

    ('aa666666-6666-6666-6666-666666666666', 'c0000000-0000-0000-0000-000000000001',
     'a3333333-3333-3333-3333-333333333333', 'AC', 'Allianz', 'ALZ/AC/2026/112',
     '2026-02-01', '2027-01-31', 4500.00, 'MONTHLY', true,
     NOW(), NOW(), gen_random_uuid()),

    ('aa777777-7777-7777-7777-777777777777', 'c0000000-0000-0000-0000-000000000001',
     'a1111111-1111-1111-1111-111111111111', 'OC', 'Ergo Hestia', 'EH/OC/2025/001',
     '2025-01-01', '2025-12-31', 1100.00, 'ANNUAL', false,
     NOW(), NOW(), gen_random_uuid());